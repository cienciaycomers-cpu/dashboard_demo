  ...
  return (
    <main className="experience-selector">
      <div className="selector-shell">
        ...
        <h1>Dos formas de leer<br /><em>la misma se&ntilde;al.</em></h1>
        <p className="selector-intro">Eleg&iacute; una experiencia para explorar el seguimiento de paid media.</p>
